...
int main() {
    ...
    // Box showing links to view the C++ source code files
    cout << "    <div class=\"source-box\">\n";
    // This div groups the source code links together
    
    cout << "        <h2>View C++ Source Code</h2>\n";
    // Heading for the source code section
    
    cout << "        <a href=\"login.cpp\">login.cpp</a>\n";
    // Link to view the authentication C++ source code
    
    cout << "        <a href=\"listings.cpp\">listings.cpp</a>\n";
    // Link to view the listings C++ source code
    
    cout << "        <a href=\"trade.cpp\">trade.cpp</a>\n";
    // Link to view the trading C++ source code
    
    cout << "        <a href=\"transactions.cpp\">transactions.cpp</a>\n";
    // Link to view the transactions C++ source code
    
    cout << "        <a href=\"index.cpp\">index.cpp</a>\n";
    // Link to view THIS file's source code
    
    cout << "        <a href=\"style.cpp\">style.cpp</a>\n";
    // Link to view the stylesheet C++ source code
    
    cout << "    </div>\n";
    // Close the source box div
    ...
    // Navigation section for viewing auctions without logging in
    cout << "        <div class=\"nav\">\n";
    // This div creates a navigation menu
    
    cout << "            <a href=\"./listings.cgi\">View All Auctions</a>\n";
    // Link that lets users see all auctions even without logging in
    
    cout << "        </div>\n";
    // Close the navigation div

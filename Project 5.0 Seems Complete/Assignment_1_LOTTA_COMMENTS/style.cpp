...
int main() {
    ...
    cout << "/* Style links when mouse hovers over them */\n";
    // The :hover pseudo-class activates when mouse is over element
    
    cout << ".nav a:hover {\n";
    // Select nav links when hovering
    
    cout << "    text-decoration: underline;\n";
    // Add underline when hovering over link
    
    cout << "}\n";
    // Close hover style rule
    ...
    cout << "/* Style buttons when mouse hovers over them */\n";
    // Give visual feedback when hovering
    
    cout << "button:hover,\n";
    // Select button elements on hover
    
    cout << ".button:hover {\n";
    // Select button class elements on hover
    
    cout << "    background-color: #0052a3;\n";
    // Darker blue when hovering over button
    
    cout << "}\n";
    // Close button hover style rule
    ...
    cout << "/* Style table rows when mouse hovers over them */\n";
    // Give visual feedback for table rows
    
    cout << "tr:hover {\n";
    // Select table rows on hover
    
    cout << "    background-color: #f5f5f5;\n";
    // Light gray background when hovering over row
    
    cout << "}\n";
    // Close tr hover style rule
    ...
    cout << "/* Style source box links when hovering */\n";
    // Give visual feedback when hovering over source links
    
    cout << ".source-box a:hover {\n";
    // Select source-box links on hover
    
    cout << "    text-decoration: underline;\n";
    // Add underline when hovering
    
    cout << "}\n";
    // Close source-box hover style rule

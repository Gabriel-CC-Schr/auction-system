...
// this function just decodes the yucky url %xx stuff we get from the
// query string from the url back into characters
...
// this extracts key=value pairs from the query string after "?" in the url
// separated by & to send to urlDecode (above) where yucky url %xx will
// be converted back into characters and to make sure spaces and symbols 
// are correct. Also, if there is no key it returns an empty string ""
...
int main() {
    ...
    if (sessionState == SESSION_LOGGED_IN) {
        ...
        cout << "        <a href=\"trade.cgi\">Buy or Sell (coming soon)</a>\n";
        cout << "        <a href=\"transactions.cgi\">My Transactions (coming soon)</a>\n";
